...
update() {
  ...
  cd $home && rm -rf sinchi && rm -rf SinChi && rm -rf .telegram-cli && sudo apt-get autoclean && sudo apt-get autoremove && git clone https://github.com/kpchannel/sinchi.git && cd sinchi && chmod +x install.sh && ./install.sh -y
}
